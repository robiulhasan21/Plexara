...
const EditProduct = ({ token }) => {
  ...
  return (
    <div className='px-2 sm:px-4 md:px-8 py-4 md:py-8 pb-28 md:pb-8 bg-gray-50 min-h-screen'>
      <form className='w-full max-w-3xl lg:max-w-4xl mx-auto flex flex-col gap-5 sm:gap-6 bg-white p-4 sm:p-6 md:p-10 rounded-2xl shadow-sm' onSubmit={handleSubmit}>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
          <div>
            ...
            <select className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl cursor-pointer outline-none 
            focus:border-[#f16c44]' value={category} onChange={handleCategoryChange} required>
          ...
          <div>
            ...
            <select className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl cursor-pointer outline-none 
            focus:border-[#f16c44]' value={type} onChange={handleTypeChange} required disabled={!category}>
              <option value="">Select</option>
          ...
          <div>
            ...
            <select className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl cursor-pointer outline-none 
            focus:border-[#f16c44]' value={subType} onChange={e => setSubType(e.target.value)} required disabled={!type}>
              <option value="">Select</option>
        ...
        {/* Bestseller Toggle */}
        <div className='flex items-center gap-3 bg-gray-50 p-4 rounded-xl w-fit cursor-pointer border border-gray-100 
        hover:border-[#f16c44]/30' onClick={() => setBestseller(!bestseller)}>
        ...
        {/* Action Button */}
        <button type="submit" className="w-full sm:w-auto sm:px-12 py-4 bg-gradient-to-r from-[#732581] via-[#f16c44] to-[#faad3a] 
        text-white font-extrabold rounded-xl shadow-xl shadow-[#f16c44]/20 hover:scale-[1.02] active:scale-95 transition-all text-lg tracking-wide">
